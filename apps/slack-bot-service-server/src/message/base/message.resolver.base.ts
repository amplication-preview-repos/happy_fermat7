...
import { BotUser } from "../../botUser/base/BotUser";
...
export class MessageResolverBase {
  ...
  async createMessage(
    ...
    return await this.service.createMessage({
      ...
      data: {
        ...
        botUser: args.data.botUser
          ? {
              connect: args.data.botUser,
            }
          : undefined,
  ...
  async getBotUser(@graphql.Parent() parent: Message): Promise<BotUser | null> {
    const result = await this.service.getBotUser(parent.id);
